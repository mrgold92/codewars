...
//
//Let'sassume that a song consists of some number of words(that don'tcontain WUB).
...
//
//Recently,Jonny has heard Polycarpus'snew dubstep track,but since he isn'tinto modern music,
//he decided to find out what was the initial song that Polycarpus remixed.Help Jonny restore the original song.
//
//Input The input consists of a single non-empty string,consisting only of uppercase English letters,
//the string's length doesn't exceed 200 characters
//
//Output Return the words of the initial song that Polycarpus used to make a dubsteb remix.
